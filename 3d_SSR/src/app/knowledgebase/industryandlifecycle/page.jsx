...
export const metadata = {
    ...
    description: "Отрасль и жизненный цикл 3D печати: от разработки и прототипирования до массового производства. Узнайте, как технологии 3D печати интегрируются в различные отрасли.",
    alternates: {
