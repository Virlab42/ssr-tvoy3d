...
export const metadata = {
    ...
    description: "Литье под давлением для 3D печати: оптимизация процесса для создания точных пластиковых деталей. Разработка форм и моделей для эффективного серийного производства.",
    alternates: {
