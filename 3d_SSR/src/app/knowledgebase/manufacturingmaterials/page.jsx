...
export const metadata = {
    ...
    description: "Материалы для 3D печати: обзор пластиков, смол и металлов. Узнайте, как выбрать оптимальный материал для ваших проектов и обеспечить высокое качество печати.",
    alternates: {
