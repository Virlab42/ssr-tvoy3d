...
export const metadata = {
    ...
    description: "Постобработка и отделка для 3D печати: шлифовка, покраска, обтяжка и покрытие. Улучшите качество и внешний вид ваших 3D-изделий для идеального завершения.",
    alternates: {
