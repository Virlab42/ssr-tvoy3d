...
export const metadata = {
    ...
    description: "Стандарты и технические данные для 3D печати: ключевые требования, спецификации и параметры для обеспечения точности и качества печати ваших изделий.",
    alternates: {
