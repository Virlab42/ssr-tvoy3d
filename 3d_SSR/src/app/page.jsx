  ...
  const cards = [
      {
          ...
          price3: "Крупные модели (более 20x20x20 см): от 5000 рублей и выше, в зависимости от размера и сложности.",
          linkone: "/servicesinfo/extrusion"
      },
      {
          ...
          price3: "Крупные модели (более 20x20x20 см): от 8000 рублей и выше, в зависимости от размера и сложности.",
          linkone: "/servicesinfo/stereolithography"
      },
      {
          ...
          price3: "Крупные модели (более 20x20x20 см): от 12000 рублей и выше, в зависимости от размера и сложности.",
          linkone: "/servicesinfo/inkjet"
      },
      {
          ...
          price3: "Крупные модели (более 20x20x20 см): от 15000 рублей и выше, в зависимости от размера и сложности.",
          linkone: "/servicesinfo/synthesis"
      }
  ];
    ...
    <>
      ...
      <div className='navigate'>
              <div className='nav1'>
                  ...
                  <div className='fon'>
                      <span className='d-btn'><button>О 3D-ПЕЧАТИ</button></span>
                  </div>
                  </Link>
              </div>
              <div className='nav2'>
                  <div>
                      ...
                      <Link smooth="true" href='/blog' >
                          <div className='fon' style={{background: 'linear-gradient(to top,rgba(0,0,0,0.6) 0%,rgba(0,0,0,0.2) 100%)'}}>
                              <span className='d-btn'><button>БЛОГ</button></span>
                          </div>
                      </Link>
                      </div>
                      <div className='nav24'>
                      <Link smooth="true" href='/services' >
                          <div className='fon' style={{background: 'linear-gradient(to top,rgba(0,0,0,0.5) 0%,rgba(0,0,0,0.2) 100%)'}}>
                              <span className='d-btn'><button>УСЛУГИ</button></span>
                          </div>
                      </Link>
                      </div>
                  </div>
                  <div>
                      ...
                      <Link smooth="true" href='/plastic' >
                          <div className='fon' style={{background: 'linear-gradient(to top,rgba(0,0,0,0.6) 0%,rgba(0,0,0,0.3) 100%)'}}>
                              <span className='d-btn'><button>МАТЕРИАЛЫ</button></span>
                          </div>
                      </Link>
                      </div>
                  </div>
          ...
          <div className="cards">
                  ...
                  <div className="card-subtitle">Загрузите свой дизайн детали в нашу форму онлайн предложений и опишите свои требования к производству детали</div>
                  </div>
                  <div className="card">
                  <div className="card-title">Получите мгновенное предложение</div>
                  <div className="card-subtitle">Мы проанализируем ваш запрос, составим спецификации, определим цену и продолжительность производства</div>
                  </div>
                  <div className="card">
                  <div className="card-title">Производство</div>
                  <div className="card-subtitle">После согласования предложения производство начинается немедленно</div>
                  </div>
                  <div className="card">
                  <div className="card-title">Контроль качества</div>
                  <div className="card-subtitle">Мы несем полную ответственность за то, чтобы ваши детали были изготовлены в соответствии с нашими стандартами</div>
                  </div>
                  <div className="card">
                  <div className="card-title">Доставка</div>
                  <div className="card-subtitle">Проверяем заказ перед отправкой и доставляем транспортной компанией</div>
                  </div>
          </div>
          </div>
          ...
          <Link href="/blog"  className="back-button">Все статьи</Link>                                
          <FormApplication/>
          <Partners/>
    </>
  );
