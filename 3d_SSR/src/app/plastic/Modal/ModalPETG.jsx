...
const ModalPETG = () => {
  ...
  <div className="modal fade" id="exampleModalPETG" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h1 className="modal-title fs-4" id="exampleModalLabel" >3D-печать из PETG</h1>
        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div className="modal-body">
        <p>Подходит для механических деталей с высокой ударопрочностью и гибкостью. Стерилизуется. PETG — термопластик с улучшенными свойствами по сравнению с PLA, с высокой ударопрочностью и превосходной химической и влагостойкостью. PETG можно стерилизовать.</p>
      </div>
      <div className="modal-footer">
  ...
  <tbody>
    <tr>
      <td className='tdEl'>
            ...
            <h1 className='fs-5'>Приложения</h1>
