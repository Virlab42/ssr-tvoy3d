...
export default function Header(){
  ...
  useEffect(() => {
    const links = document.querySelectorAll("#navbarNavDropdown .nav-close, #navbarNavDropdown .dropdown-item,  .navbar-brand,.nav-link,.d-btn");
    links.forEach(link => {
  ...
  useEffect(()=>{
    ...
    return(
        ...
        <>
          ...
          <nav className={`navbar navbar-expand-lg bg-body-tertiary ${opacity?`unTransparent`:""}`}>
          <div className="container-fluid">
            <Link smooth="true" href='/' onClick={() => window.scrollTo(0, 0)} className="navbar-brand">
              ...
              <span className='brand-name' style={{fontWeight: 300, marginLeft: 10, marginRight: 50, fontSize: 22}}>Твой <span style={{fontWeight: 700}}>3D</span></span>
            </Link>
            <button id='navbar-toggler' className="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Переключатель навигации">
              <span className="navbar-toggler-icon"></span>
            </button>
            <div className={`collapse navbar-collapse`} id="navbarNavDropdown">
              <ul className="navbar-nav">
                <li className="nav-item">
                  <Link smooth="true" href='/' onClick={() => window.scrollTo(0, 0)} className="nav-link">ГЛАВНАЯ</Link>
                </li>
                <li className="nav-item">
                  <Link smooth="true" href='/blog' onClick={() => window.scrollTo(0, 0)} className="nav-link">БЛОГ</Link>
                </li>
                <li className="nav-item">
                  <Link smooth="true" href='/knowledgebase' onClick={() => window.scrollTo(0, 0)} className="nav-link">БАЗА ЗНАНИЙ</Link>
                </li>
            
                <li className="nav-item dropdown">
                  <a className="dropdown-toggle nav-dropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    КОМПАНИЯ
                  </a>
                  <ul className={`dropdown-menu ${opacity?`unTransparent`:""}`}>
                    <li><Link smooth="true" href='/about' onClick={() => window.scrollTo(0, 0)} className="dropdown-item">О НАС</Link></li>
                    <li><Link smooth="true" href='/services' onClick={() => window.scrollTo(0, 0)} className="dropdown-item">УСЛУГИ</Link></li>
                    <li><Link smooth="true" href='/contacts' onClick={() => window.scrollTo(0, 0)} className="dropdown-item">КОНТАКТЫ</Link></li>
                    <li><Link smooth="true" href='/question' onClick={() => window.scrollTo(0, 0)} className="dropdown-item">ЗАДАТЬ ВОПРОС</Link></li>
              ...
              <div className='telbut'>
								<Link smooth="true" href='tel:+79936307048' className='nav-link'>+7 993-630-70-48</Link>
