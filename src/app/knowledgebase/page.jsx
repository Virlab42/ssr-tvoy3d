...
export const metadata = {
    title: "3D-Печать | База знаний",
    description: "База знаний по 3D печати: руководство по технологиям, советы по выбору материалов, настройки принтеров и устранение неполадок. Найдите ответы на все вопросы.",
    alternates: {
