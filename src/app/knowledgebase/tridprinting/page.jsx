...
export const metadata = {
    title: "3D Печать: Технологии и Решения",
    description: "3D печать: исследуйте передовые технологии и решения для создания прототипов, деталей и изделий. Узнайте о возможностях и преимуществах аддитивного производства.",
    alternates: {
