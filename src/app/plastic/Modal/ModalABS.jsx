...
const ModalABS= () => {
  ...
  <div className="modal fade" id="exampleModalABS" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h1 className="modal-title fs-4" id="exampleModalLabel" >3D-печать из ABS</h1>
        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div className="modal-body">
        <p>Пластик общего назначения, улучшенные механические и термические свойства по сравнению с PLA. ABS — это распространенный термопластик с хорошими механическими свойствами и превосходной ударной вязкостью, превосходящий PLA, но с менее четкими деталями.</p>
      </div>
      <div className="modal-footer">
