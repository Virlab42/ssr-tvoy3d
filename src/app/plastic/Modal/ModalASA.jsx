...
const ModalASA = () => {
  ...
  <div className="modal fade" id="exampleModalASA" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h1 className="modal-title fs-4" id="exampleModalLabel" >3D-печать из ASA</h1>
        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div className="modal-body">
        <p>Устойчивость к УФ-излучению и высокая химическая стойкость, предпочтительный материал для наружного применения. ASA — термопластик со свойствами, аналогичными ABS, но с улучшенной термической, химической и атмосферной стойкостью. Идеально подходит для наружного применения.</p>
      </div>
      <div className="modal-footer">
        <h1 className='fs-4'> Описание</h1>
        <p className='modal-body'>Промышленный FDM</p>
  ...
  <tbody>
      ...
      <td>
        ...
        Больший размер сборки по сравнению с настольным FDM, промышленные материалы, более жесткие допуски по сравнению с настольным FDM</p>
      </td>
      </tr>
      <tr>
      <td className='tdEl'>
