...
const ModalPEI = () => {
  ...
  <div className="modal fade" id="exampleModalPEI" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h1 className="modal-title fs-4" id="exampleModalLabel" >3D-печать из PEI</h1>
        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div className="modal-body">
        <p>Инженерный пластик, высокопроизводительное применение, огнестойкий. PEI — инженерный термопластик с хорошими механическими свойствами и исключительной стойкостью к воздействию тепла, химических веществ и пламени.</p>
      </div>
      <div className="modal-footer">
