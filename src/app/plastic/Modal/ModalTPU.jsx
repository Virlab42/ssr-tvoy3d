...
const ModalTPU = () => {
  ...
  <div className="modal fade" id="exampleModalTPU" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h1 className="modal-title fs-4" id="exampleModalLabel" >3D-печать из TPU</h1>
        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div className="modal-body">
        <p>Резиноподобный материал, подходит для трубок, ручек, уплотнителей и прокладок. TPU — термопластичный эластомер с низкой твердостью по Шору 85-95A</p>
      </div>
      <div className="modal-footer">
